...
#[derive(Debug)]
pub struct PlasmaCoreProcessor {
    verbose: bool,
    processed_count: usize,
}

impl PlasmaCoreProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting PlasmaCore processing");
    
    let mut processor = PlasmaCoreProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = PlasmaCoreProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = PlasmaCoreProcessor::new(false);
